...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label ID="Label4" runat="server" Text="E-Mailiniz"></asp:Label>
            ...
            <br />
            <div>
                <asp:Label ID="Label6" runat="server" Text="Notlarınız"></asp:Label>
                <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control" Height="100px" TextMode="MultiLine"></asp:TextBox>
            </div>
            <br />
            <div>
                <asp:Label ID="Label7" runat="server" Text="Fotoğraflarınız"></asp:Label>
                <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <br />
            <asp:Button ID="Button1" runat="server" Text="Bilgilerinizi Güncelleyiniz" CssClass="btn btn-success" OnClick="Button1_Click" />
        </div>
