<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEgitimEkle.aspx.cs" Inherits="CVSite.AdminEgitimEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Eğitimi Kaydet" CssClass="btn btn-success" OnClick="Button1_Click1" />
        </div>
    </form>
</asp:Content>
